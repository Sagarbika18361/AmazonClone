              ...
              <div className="modal-header videoAndImage mx-auto pb-0">
                <ul className="nav nav-pills vidAndImg position-relative ">
                  <li className="nav-item">
                    <a
                      className="nav-link rounded-0 fw-bold "
                      data-bs-toggle="pill"
                      href="#home"
                    >
                      VIDEOS
                ...
                <button
                  type="button"
                  className="btn-close videoClsBtn"
                  ...
                  <div className="tab-pane container active" id="home">
                    <div className="row m-0 ">
                      <div className="col-7 h-100 ">
                        <video
                          className="img-fluid h-100 w-100 rounded-1  "
                          controls
                        >
                        ...
                        <h6>
                          {" "}
                          ASUS ROG Zephyrus G14, 14" FHD 120Hz, Ryzen 5 4600HS,
                          GTX 1650Ti 4GB Graphics, Gaming laptop{" "}
                        </h6>
                        <p> Amazon Videos </p>
                      </div>
                      <div className="col-5 h-100 p-0 h-75 ">
                        ...
                        <span
                          className="badge bg-secondary w-100 text-dark text-start "
                  ...
                  <div className="tab-pane container fade" id="menu1">
                    <div className="row overflow-hidden">
                      <div className="col-9 h-100 ">
                        <img
                          src="https://m.media-amazon.com/images/I/91Oam4MucXL._SL1500_.jpg"
                          className="img-fluid imgLaptop position-relative "
                          alt="..img"
                        />
                      </div>
                      <div className="col-3 h-100 ">
                        <span className="fw-bolder">
                          {" "}
                          ASUS ROG Zephyrus G14 AMD Ryzen 5 4600HS 14 inches FHD
                          120Hz, NVIDIA GTX 1650Ti 4GB Graphics, Gaming Laptop
                          (8GB/512GB SSD/Office 2019/Windows 10/White/Anime
                          Matrix/1.7 Kg), GA401II-HE127TS
                        </span>

                        <p>
                          Pattern name: <span>Laptop</span>{" "}
                        </p>

                        <ul className="nav mb-2 ">
                          <li className="nav-item  prImgHover prImgHoverNone">
                            <a className="nav-link px-0 m-1 " href="#detail">
                              <img
                                src="https://m.media-amazon.com/images/I/41vBR51y8jL._AA50_.jpg"
                                alt="img... "
                                className="img-fluid "
                              />
                            </a>
                          ...
                          <li className="nav-item prImgHover prImgHoverNone ">
                            <a className="nav-link px-0 m-1 " href="#detail">
                              <img
                                src="https://m.media-amazon.com/images/I/51Jj+Qfs-zL._AA50_.jpg"
                                alt="img... "
                                className="img-fluid "
                              />
                            </a>
                          ...
                          <li className="nav-item prImgHover prImgHoverNone ">
                            <a className="nav-link px-0 m-0 " href="#detail">
                              <img
                                src="https://m.media-amazon.com/images/I/51OMV88VFLL._AA50_.jpg"
                                alt="img... "
                                className="img-fluid "
                              />
                            </a>
                          ...
                          <li className="nav-item prImgHover prImgHoverNone ">
                            <a className="nav-link px-0 m-0 " href="#detail">
                              <img
                                src="https://m.media-amazon.com/images/I/41PTXuJIfgL._AA50_.jpg"
                                alt="img... "
                                className="img-fluid "
                              />
                            </a>
                        ...
                        <ul className="nav">
                          <li className="nav-item prImgHover prImgHoverNone ">
                            <a className="nav-link px-0 m-1  " href="#detail">
                              <img
                                src="https://m.media-amazon.com/images/I/41IDf6ZPXaL._AA50_.jpg"
                                alt="img... "
                                className="img-fluid "
                              />
                            </a>
                          ...
                          <li className="nav-item prImgHover prImgHoverNone ">
                            <a className="nav-link px-0 m-1 " href="#detail">
                              <img
                                src="https://m.media-amazon.com/images/I/41upE6fqmbL._AA50_.jpg"
                                alt="img... "
                                className="img-fluid "
                              />
                            </a>
                          ...
                          <li className="nav-item prImgHover prImgHoverNone ">
                            <a className="nav-link px-0 m-0 " href="#detail">
                              <img
                                src="https://m.media-amazon.com/images/I/41wu2KRhtML._AA50_.jpg"
                                alt="img... "
                                className="img-fluid "
                              />
                            </a>
                          ...
                          <li className="nav-item prImgHover prImgHoverNone ">
                            <a className="nav-link px-0 m-1 " href="#detail">
                              {" "}
                              <img
                                src="https://m.media-amazon.com/images/I/51z0SkOXqmL._AA50_.jpg"
                                alt="img... "
                                className="img-fluid "
                              />
                            </a>
          ...
          <div className="dtl_top_consider_this_item tbdr d-none ">
            ...
            <div className="row m-0 h-75  ">
              <div className="col-4 p-0 tbdr">
                <a
                  href="/detail"
                  className="btn btn-danger rounded-0 w-100 border-0 h-100 "
                >
                  {" "}
                </a>
              </div>
            ...
            <div className="col-10 p-0 tbdr">
              <div className="row m-0  h-100">
                <div className="col-1 p-0 tbdr">
                  ...
                  <ul
                    className={
                      " a_dtl_thumbnail nav flex-column  mx-auto  " +
                      scroll.prodScrollFix
                    }
                  >
                    <li className="nav-item">
                      <a
                        className="nav-link p-0 mb-2 mt-1 border "
                        href="/detail"
                      >
                        <img
                          src="https://m.media-amazon.com/images/I/61TlKHyOHLL._SL1000_.jpg "
                          className="img-fluid"
                          alt=""
                        />
                      </a>
                    ...
                    <li className="nav-item">
                      <a
                        className="nav-link p-0 mb-2  mt-1 border overflow-hidden  "
                      ...
                      >
                        <img
                          src={Img3}
                          className=" play_btn img-fluid position-absolute"
                          alt="play"
                        />
                        <img
                          src="https://m.media-amazon.com/images/I/61TlKHyOHLL._SL1000_.jpg "
                ...
                <div className="col-6 p-0 tbdr">
                  <div
                    className={
                      " d-none a_detail_proMainImg  " + scroll.prodScrollFix
                    }
                  >
                    <ReactImageMagnify
                      {...{
                ...
                <div className="col-5 p-0 laptop tbdr">
                  <h4>
                    Lenovo IdeaPad Slim 3 2021 11th Gen Intel Core i5 15.6 FHD
                    Thin & Light Laptop (8GB/512GB SSD/Windows 10/MS
                    Office/Backlit Keyboard/2 Year Warranty/Arctic Grey/1.65Kg),
                    82H801CWIN
                  </h4>
                  <a
                    href="/"
                    className="btn btn-link text-start d-block"
                    style={{ color: "#007185" }}
                  >
                  ...
                  >
                    Price:{" "}
                    <span style={{ color: "#B12704" }}> ₹57,990.00 </span>{" "}
                  </span>
                  <span
                    className="d-block text-start"
                    style={{ color: "565959" }}
                  >
                    You Save:{" "}
                    <span style={{ color: "#B12704" }}> ₹21,900.00(27%) </span>{" "}
                  </span>
                  <ul className="list-group">
                    <li className="list-group-item">
                      {" "}
                      <span style={{ color: "565959" }}>Save</span> Extra with 4
                      offers
                    </li>
                    <li className="list-group-item">
                      EMI starts at ₹2,777. No Cost EMI available EMI
                    </li>
                    <li className="list-group-item">
                      Exchange Offer: Up to ₹17,950.00 off on Exchange
                    </li>
                    <li className="list-group-item">
                      <a href="/">See 3 more</a>
                    </li>
                  ...
                  <a className="btn btn-link" href="#productInfo">
                    {" "}
            ...
            <div className="col-2 tbdr p-0">
              ...
              <form>
                <div className="card">
                  ...
                  <div className="card-body ps-3">
                    <div className="form-check  ">
                      ...
                      >
                        ...
                        <span className="float-start d-inline-block  text-danger exchangeFont ">
                          {" "}
                          ₹ 50,000.00{" "}
                        </span>{" "}
                        &nbsp;{" "}
                        <span className=" exchangeFont d-inline-block float-end  text-decoration-line-through">
                          {" "}
                          ₹ 80,000.00{" "}
                        </span>
                      </label>
                  ...
                  <hr />
                  <select
                    className="form-select w-75 mb-3 mx-auto"
                    aria-label="Default select example"
                  >
                  ...
                  <a href="/detail" className=" d-block  dtl_sponsored ">
                    <div className="   dtl_sponsoredImg overflow-hidden">
                      <img
                        ...
                        src="https://m.media-amazon.com/images/I/417BhGZxmEL.jpg"
                        alt="...sponsored"
                      />
                    </div>
                    <span className=" text-muted me-2 position-relative float-end">
                      {" "}
                      Sponsored{" "}
                      <img
                        className="img-fluid  infoCircle"
                        src={img1}
                        alt="info"
                      />{" "}
                    </span>
          ...
          <div className="a_dtl_FreqBoughtTogether border-top border-bottom tbdr">
            ...
            <nav aria-label="breadcrumb">
              <ul className="breadcrumb">
                <li className="breadcrumb-item">
                  <a href="#home">
                    <img
                      src="https://images-eu.ssl-images-amazon.com/images/I/71S8U9VzLTL._AC_UL116_SR116,116_.jpg"
                      alt="img..."
                    />
                  </a>
                </li>
                <li className="breadcrumb-item">
                  <a href="#library">
                    <img
                      src="https://images-eu.ssl-images-amazon.com/images/I/51kdFjyPRAL._AC_UL116_SR116,116_.jpg"
                      alt="img..."
                    />
                  </a>
                </li>
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="flexCheckDefault">
                This item: ASUS ROG Zephyrus G14 AMD Ryzen 5 4600HS 14 inches
                FHD 120Hz, NVIDIA GTX 1650Ti 4GB Graphics,...{" "}
                <span className="text-danger ">₹81,990.00</span>
              </label>
            </div>
            <div class="form-check">
              <input
              ...
              <label class="form-check-label" for="flexCheckChecked">
                Asus ROG BP1501 15.6-inch Gaming Laptop Backpack (Black){" "}
                <span className="text-danger">₹1,499.00</span>
              </label>
            </div>
          </div>
          ...
          <div className="a_dtl_prodInfo">
            <div className="row">
              <div className="col border-top">
                <h5 id="productInfo" className="text-warning pt-2 pb-2">
                  Product information
                </h5>
                ...
                <table className="table pt-2 ">
                  <thead>
                    <tr className="border-top">
                      <th className="table-light w-50" scope="col">
                        #
                      </th>
                  ...
                  <tbody>
                    <tr>
                      <th className="table-light w-50" scope="row">
                        1
                      </th>
                      <td>Mark</td>
                    </tr>
          ...
          <div className="a_dtl_custQnA tbdr">
            ...
            <form>
              <input
                ...
                placeholder="Have a question? Search htmlFor answers "
              />
            </form>
          </div>
                  ...
                  <table className="table progTab">
                    <tbody>
                      <tr>
                        ...
                        <td className="w-50">
                          <div
                            className="  progPos progress bg-warning mb-3   "
                            style={{ width: "73%" }}
                          >
                            <div
                      ...
                      <tr>
                        ...
                        <td className="w-50">
                          <div
                            className="progress  mb-3 bg-warning progPos  "
                            style={{ width: "22%" }}
                          >
                            <div
                              className="progress-bar "
                      ...
                      <tr>
                        ...
                        <td className="w-50">
                          <div
                            className="progress mb-3 progPos bg-warning  "
                            style={{ width: "44%" }}
                          >
                            <div
                              className="progress-bar "
              ...
              <div className="col-8 tbdr">
                ...
                <div className="a_indiviual_comment mt-3 tbdr">
                  <div>
                    ...
                    <span className="userName ">Vinod Kumar</span>
                  </div>
                  <div className="custIdEleg">
                    ...
                    <a
                      className="elegant text-decoration-none"
                      href="/"
                      style={{ color: "#007185" }}
                    >
                      {" "}
                      Elegant Design with Superb Features{" "}
                    </a>
                  </div>
                  ...
                  <p>
                    {" "}
                    The whole experience from delivery to commissioning was
                    completely seamless; the packaging is strong and very
                    sturdy, using a lot of bio-degradable materials; the
                    unboxing was a delight, and fixing the (included) wall mount
                    was a piece of cake. bio-degradable materials; the unboxing
                    was a delight, and fixing the (included) wall mount was a
                    piece of cake. bio-degradable materials; the unboxing was a
                    delight, and fixing the (included) wall mount was a piece of
                    cake. bio-degradable materials; the unboxing was a delight,
                    and fixing the (included) wall mount was a piece of cake.
                    bio-degradable materials; the unboxing was a delight, and
                    fixing the (included) wall mount was a piece of cake.
                    bæio-degradable materials; the unboxing was a delight, and
                    fixing the (included) wall mount was a piece of cake.
                    bio-degradable materials; the unboxing was a delight, and
                    fixing the (included) wall mount was a piece of cake.
                    bio-degradable materials; the unboxing was a delight, and
                    fixing the (included) wall mount was a piece of cake.
                    bio-degradable materials; bio-degradable materials; the
                    unboxing was a delight, and fixing the (included) wall mount
                    was a piece of cake. bio-degradable materials; the unboxing
                    was a delight, and fixing the (included) wall mount was a
                    piece of cake. bio-degradable materials;
                  </p>
                ...
                <div className="a_indiviual_comment mt-5 tbdr">
                  <div>
                    <FontAwesomeIcon icon={faUserAlt} />{" "}
                    <span className="userName ">Ajay Kumar</span>
                  </div>
                  <div className="custIdEleg">
                    <FontAwesomeIcon className="text-warning" icon={faStar} />
                    <FontAwesomeIcon className="text-warning" icon={faStar} />
